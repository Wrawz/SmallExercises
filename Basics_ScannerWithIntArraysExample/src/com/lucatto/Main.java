...
//        System.out.println(ArrayMethods.getInstance().findEarlierRepeatedElement(new int[]{3, 2, 5, 7, 7, 5, 2, 3}));
//        System.out.println(Arrays.toString(ArrayMethods.getInstance().reversedArray(new int[]{3, 2, 5, 7, 3, 2})));
            ...
            if (scanner.hasNextInt()) {
                ...
                switch (number) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        System.out.println(Arrays.toString(ArrayMethods.getInstance().reversedArray(userIntArray)));
                        break;
                    default:
                        continue;
                }
