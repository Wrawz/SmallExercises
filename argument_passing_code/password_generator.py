...
def get_arguments() -> int:
    ...
    if options.length == 0:  # this line of code is mandatory. Otherwise, if you pass 0 as an arg, it understands as None. And, if you just move "options.length < 8:" to this line instead, it will still not work.
        return -1
