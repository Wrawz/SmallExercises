...
public class Burger {
    ...
    public Burger(int type, int toppingQuantity, int beverageType, String friesSize) {
        this.type = type >= 1 && type <= 4 ? type : 1;
        this.toppingQuantity = toppingQuantity >= 0 && toppingQuantity <= 10 ? toppingQuantity : 0;
        this.beverageType = beverageType >= 0 && beverageType <= 3 ? beverageType : 0;
